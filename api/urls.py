...
urlpatterns = [
    ...
    path('forms/<int:pk>', views.RetrieveUpdateDestroyForm.as_view(), name="form"),
    ...
    path('destinations/<int:pk>', views.RetrieveUpdateDestroyDestination.as_view(), name="destination"),
]
